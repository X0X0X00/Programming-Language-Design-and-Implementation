...
echo -n "Test 19 (undeclared variable use): "
...
echo -n "Test 20 (variable redeclaration in same scope): "
...
echo -n "Test 21 (type mismatch in assignment int to real): "
...
echo -n "Test 22 (type mismatch in assignment real to int): "
...
echo -n "Test 23 (non-int operand to 'and'): "
...
echo -n "Test 24 (non-int operand to 'or'): "
...
echo -n "Test 25 (non-int argument to float): "
...
echo -n "Test 26 (non-real argument to trunc): "
...
echo -n "Test 27 (check statement outside loop): "
...
echo -n "Test 28 (check in if block but not in loop): "
...
echo -n "Test 29 (type mismatch in binary expression): "
...
echo -n "Test 30 (undeclared variable in expression): "
...
echo -n "Test 31 (inequality operators): "
...
echo -n "Test 32 (division by zero): "
...
echo -n "Test 33 (non-int input when reading int): "
...
echo -n "Test 34 (non-real input when reading real): "
...
echo -n "Test 35 (unexpected end of input): "
...
echo -n "Test 36 (division by zero with variables): "
...
echo -n "Test 37 (real division by zero): "
...
echo -n "Test 38 (variable shadowing in nested scope): "
...
echo -n "Test 39 (variable scope in if block): "
...
echo -n "Test 40 (variable scope in else block): "
...
echo -n "Test 42 (multiple writes on same line): "
...
echo -n "Test 43 (empty if-then block): "
...
echo -n "Test 44 (zero as condition): "
...
echo -n "Test 45 (non-zero as condition): "
...
echo -n "Test 46 (real number precision): "
